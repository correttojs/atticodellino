...
export type ReservationsQuery = { __typename?: "Query" } & {
  reservations?: Types.Maybe<
    Array<Types.Maybe<{ __typename?: "Reservation" } & ReservationRespFragment>>
  >;
};

export type SyncRegistrationsQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type SyncRegistrationsQuery = { __typename?: "Query" } & {
  syncReservations?: Types.Maybe<
    Array<Types.Maybe<{ __typename?: "Reservation" } & ReservationRespFragment>>
  >;
};

export type ReservationRespFragment = { __typename?: "Reservation" } & Pick<
  Types.Reservation,
  | "id"
  | "guest_name"
  | "check_out"
...
> & {
    guests?: Types.Maybe<
      Array<
        Types.Maybe<
          { __typename?: "GuestRegistration" } & Pick<
            Types.GuestRegistration,
            | "birthDate"
            | "documentNumber"
            | "documentType"
            | "documentPlace"
...
export const ReservationRespFragmentDoc: DocumentNode<
  ...
  definitions: [
    {
      ...
      name: { kind: "Name", value: "ReservationResp" },
      typeCondition: {
        kind: "NamedType",
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: "Field", name: { kind: "Name", value: "registrationUrl" } },
...
export const ReservationsDocument: DocumentNode<
  ReservationsQuery,
...
> = {
  ...
  definitions: [
    ...
    ...ReservationRespFragmentDoc.definitions,
  ],
};
export const SyncRegistrationsDocument: DocumentNode<
  SyncRegistrationsQuery,
  SyncRegistrationsQueryVariables
> = {
  kind: "Document",
  definitions: [
    {
...
export const UpdateReservationStatusDocument: DocumentNode<
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "updateReservationStatus" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
