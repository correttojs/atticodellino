...
export const RegisterDocument: DocumentNode<
  RegisterMutation,
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "registerGuests" },
            arguments: [
              {
                kind: "Argument",
...
export const ReservationDocument: DocumentNode<
  ReservationQuery,
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "displayHome" } },
                ...
                { kind: "Field", name: { kind: "Name", value: "mapLink" } },
                { kind: "Field", name: { kind: "Name", value: "airbnbLink" } },
              ],
            },
          },
        ],
