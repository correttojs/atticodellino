...
export type RegisterMutationVariables = Types.Exact<{
  ...
  file: Array<Types.Maybe<Types.Scalars['Upload']>> | Types.Maybe<Types.Scalars['Upload']>;
}>;
...
export type ReservationQuery = (
  ...
  & { reservation?: Types.Maybe<(
    { __typename?: 'Reservation' }
    & Pick<Types.Reservation, 'guest_name' | 'check_out' | 'check_in' | 'phone' | 'home' | 'address' | 'displayHome' | 'isExpired' | 'code' | 'mapLink' | 'airbnbLink'>
