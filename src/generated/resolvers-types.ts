...
export type IGuestResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["IGuest"] = ResolversParentTypes["IGuest"]
> = {
...
export type GuestMailResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["GuestMail"] = ResolversParentTypes["GuestMail"]
> = {
  firstName?: Resolver<
...
export type ReviewTypeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["ReviewType"] = ResolversParentTypes["ReviewType"]
> = {
...
export type BookResponseResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["BookResponse"] = ResolversParentTypes["BookResponse"]
> = {
  firstName?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
...
export type GuestRegistrationResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["GuestRegistration"] = ResolversParentTypes["GuestRegistration"]
> = {
  firstName?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  lastName?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  documentNumber?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
> = {
  ...
  reservationStatus?: Resolver<
    Maybe<ResolversTypes["ReservationStatus"]>,
    ParentType,
    ContextType
  >;
  guests?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["GuestRegistration"]>>>,
    ParentType,
    ContextType
  >;
  address?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
  displayHome?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
...
export type ReservationShortResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["ReservationShort"] = ResolversParentTypes["ReservationShort"]
> = {
  check_in?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
  check_out?: Resolver<
    Maybe<ResolversTypes["String"]>,
...
> = {
  book?: Resolver<
    Maybe<ResolversTypes["BookResponse"]>,
    ParentType,
    ContextType,
    RequireFields<MutationBookArgs, never>
  >;
  registerGuests?: Resolver<
    Maybe<ResolversTypes["ReservationStatus"]>,
    ParentType,
    ContextType,
    RequireFields<MutationRegisterGuestsArgs, "user" | "file">
  >;
  updateReservationStatus?: Resolver<
    Maybe<ResolversTypes["ReservationStatus"]>,
    ParentType,
    ContextType,
    RequireFields<
      MutationUpdateReservationStatusArgs,
      "id" | "hash" | "reservationStatus"
    >
  >;
};
...
> = {
  price?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryPriceArgs, "from" | "to" | "airBnb">
  >;
  reviews?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["ReviewType"]>>>,
    ParentType,
    ContextType,
    RequireFields<QueryReviewsArgs, "airBnb">
  >;
  calendar?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["Calendar"]>>>,
    ParentType,
    ContextType,
    RequireFields<QueryCalendarArgs, "apartment">
  >;
  syncReservations?: Resolver<
  ...
  reservations?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryReservationsArgs, "isPast">
  >;
  reservation?: Resolver<
    Maybe<ResolversTypes["Reservation"]>,
    ParentType,
    ContextType,
    RequireFields<QueryReservationArgs, "hash">
  >;
  faq?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["Faq"]>>>,
    ParentType,
    ContextType,
    RequireFields<QueryFaqArgs, "hash">
  >;
};
